...
# python3 otu_correlation.py --dtype all_relative --json_name arch --label_type grouped --taxa_level 5 --filter_by_taxa_level 0 --filter_by_taxa_name Archaea --limiar_alpha 0 --limiar_beta 0.5 --score_type reg
# echo "Computing correlations for Archaea entries with pearson correlation..."
# python3 otu_correlation.py --dtype all_relative --json_name arch_pearson --label_type grouped --taxa_level 5 --filter_by_taxa_level 0 --filter_by_taxa_name Archaea --limiar_alpha 0 --limiar_beta 0.5 --score_type pearson
# echo "Computing correlations for Archaea entries with spearman correlation..."
# python3 otu_correlation.py --dtype all_relative --json_name arch_spearman --label_type grouped --taxa_level 5 --filter_by_taxa_level 0 --filter_by_taxa_name Archaea --limiar_alpha 0 --limiar_beta 0.5 --score_type spearman
# echo "Computing correlations for Archaea entries with kendall correlation..."
# python3 otu_correlation.py --dtype all_relative --json_name arch_kendall --label_type grouped --taxa_level 5 --filter_by_taxa_level 0 --filter_by_taxa_name Archaea --limiar_alpha 0 --limiar_beta 0.5 --score_type kendall
